...
def find_unique_means_and_merge_weights(means, log_weights, sort=False):
    ...
    #Compute the new weights with a logsumexp
    ...
    return unique_means, unique_log_weights, num_k
